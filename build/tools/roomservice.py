...
if not depsonly:
    githubreq = urllib.request.Request("https://raw.githubusercontent.com/MistOS-Devices/official_devices/15/devices.xml")
    try:
...
def get_default_revision():
    m = ElementTree.parse(".repo/manifests/snippets/mist.xml")
...
def get_default_or_fallback_revision(repo_name):
    ...
    try:
        stdout = subprocess.run(
            ["git", "ls-remote", "-h", "https://:@github.com/Mist Devices/" + repo_name],
